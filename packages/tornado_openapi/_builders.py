...
from packages.tornado_openapi.const import API_OPENAPI_3, API_SWAGGER_2
...
def generate_doc_from_endpoints(
    ...
    *,
    ...
    from packages.tornado_openapi.model import export_swagger_models
    from packages.tornado_openapi.parameter import export_swagger_parameters
