...
function UsagePie(width, height, setValueObj,usage){
...
function updateUsage(){
    $.ajax({
        ...
        success: function (result){
            ...
            UsagePie(Width, Height, initStyle,result.CPU_Persent);
            //UsagePie(Width, Height, initStyle,result.memUsage,Width+100);
        }
      });
