...
class RESTHandler(tornado.web.RequestHandler):
    ...
    async def ROS_service_handler(self,calldata,needReturn):
    ...
    async def ROS_subscribe_call_handler(self,calldata,needReturn):
        ...
        if  subdata != None and subdata['data'] != None:
            ...
            try:                    
                await asyncio.wait_for( ROSConn.prepare_subscribe_from_ROS(ROSConn,subFuture,calldata) , timeout = restTimeoutPeriod)
